...
(function () {
  ...
  var WA_NUMBER = '918057470837'; // WhatsApp contact
  ...
  var SERVICES = [
    {
      ...
      desc: 'Professional website development tailored to your business needs.',
      price: '', priceRaw: 0,
    ...
    grid.innerHTML = filtered.map(function (s) {
      return '<div class="sv-card" data-id="' + s.id + '">' +
        ...
        '<div class="sv-card-body">' +
          ...
          '</div>' +
        '</div>' +
        '<a href="https://wa.me/918057470837?text=' + encodeURIComponent('Hi, I am interested in: ') + '" class="sv-card-cta" data-id="' + s.id + '" data-name="' + s.title + '" data-price="' + s.price + '" data-cat="' + s.category + '">' +
  ...
  function handleOrder(btn) {
    ...
    var waUrl = 'https://wa.me/918057470837?text=' + encodeURIComponent('Hi, I am interested in: ' + name);
    btn.href = waUrl;
  }
